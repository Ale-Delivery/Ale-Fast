...
class AppColors {
  ...
  static const Color lightBg = Color(0xFFF5F6FA); // alias for bg
  ...
  static const Color grey = Color(0xFF6B7280); // same as muted
  static const Color greyLight = Color(0xFFE5E7EB); // same as border
  static const Color dark = Color(0xFF1E1E2C); // same as ink
}
